...
export default function OAuthSetupPage() {
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 py-12 sm:py-16 md:py-20">
      <div className="px-4 sm:px-6 md:px-8 lg:px-12 max-w-full lg:max-w-6xl mx-auto">
        {/* Header */}
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full px-4 py-2 sm:px-6 sm:py-3 mb-4 sm:mb-6 md:mb-8 shadow-lg border border-blue-200/50">
            ...
            <span className="text-xs sm:text-sm font-semibold text-blue-800">OAuth Configuration</span>
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-4 sm:mb-6 bg-gradient-to-r from-slate-900 via-blue-900 to-purple-900 bg-clip-text text-transparent px-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6 sm:space-y-8">
            {/* Prerequisites */}
            <div className="bg-white/60 backdrop-blur-2xl rounded-2xl sm:rounded-3xl border border-white/40 shadow-2xl p-4 sm:p-6 md:p-8">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="p-2 sm:p-3 bg-gradient-to-br from-green-500/20 to-emerald-500/20 rounded-xl sm:rounded-2xl border border-green-200/30">
            ...
            <div className="bg-white/60 backdrop-blur-2xl rounded-2xl sm:rounded-3xl border border-white/40 shadow-2xl p-4 sm:p-6 md:p-8">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="p-2 sm:p-3 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-xl sm:rounded-2xl border border-blue-200/30">
              ...
              <div className="space-y-3 sm:space-y-4">
                <ol className="space-y-2 sm:space-y-3 text-sm sm:text-base text-slate-600">
            ...
            <div className="bg-white/60 backdrop-blur-2xl rounded-2xl sm:rounded-3xl border border-white/40 shadow-2xl p-4 sm:p-6 md:p-8">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="p-2 sm:p-3 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-xl sm:rounded-2xl border border-purple-200/30">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="bg-blue-50/50 border border-blue-200/30 rounded-xl sm:rounded-2xl p-3 sm:p-4 mb-3 sm:mb-4">
                  <div className="flex items-start gap-2 sm:gap-3">
                    <Mail className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="text-sm sm:text-base text-blue-800 font-medium">Gmail Account Requirement</p>
                      <p className="text-xs sm:text-sm text-blue-700">Currently, QuickERP only supports <strong>@gmail.com</strong> accounts. Make sure to connect with a Gmail account during setup, not other Google Workspace or custom domain emails.</p>
                    </div>
                  </div>
                </div>
                <div className="bg-amber-50/50 border border-amber-200/30 rounded-xl sm:rounded-2xl p-3 sm:p-4">
                  <div className="flex items-start gap-2 sm:gap-3">
                    <AlertTriangle className="w-4 h-4 sm:w-5 sm:h-5 text-amber-600 mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="text-sm sm:text-base text-amber-800 font-medium">Note</p>
                      <p className="text-xs sm:text-sm text-amber-700">Google+ API is needed even though it's deprecated, as it still handles the userinfo scopes used by Chrome extensions.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white/60 backdrop-blur-2xl rounded-2xl sm:rounded-3xl border border-white/40 shadow-2xl p-4 sm:p-6 md:p-8">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="p-2 sm:p-3 bg-gradient-to-br from-green-500/20 to-teal-500/20 rounded-xl sm:rounded-2xl border border-green-200/30">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-slate-900 mb-2 sm:mb-3">Initial Setup</h3>
                  <ol className="space-y-2 sm:space-y-3 text-sm sm:text-base text-slate-600">
                    <li className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-slate-900 mb-2 sm:mb-3">Required Information</h3>
                  <div className="bg-green-50/50 rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-green-200/30">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-slate-900 mb-2 sm:mb-3">Add Scopes</h3>
                  <ol className="space-y-2 sm:space-y-3 text-sm sm:text-base text-slate-600 mb-3 sm:mb-4">
                    <li className="flex items-start gap-3">
                      <span className="bg-green-100 text-green-800 text-sm font-semibold px-2 py-1 rounded-full min-w-[24px] text-center">1</span>
                      <span>Click <strong>"Add or Remove Scopes"</strong></span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="bg-green-100 text-green-800 text-sm font-semibold px-2 py-1 rounded-full min-w-[24px] text-center flex-shrink-0">2</span>
                      <div className="flex-1 min-w-0">
                        <span>Add these scopes:</span>
                        <div className="mt-2 bg-slate-50 p-2 sm:p-3 rounded-lg overflow-x-auto">
                          <pre className="font-mono text-xs sm:text-sm">{`• https://www.googleapis.com/auth/userinfo.email
...
• openid`}</pre>
                  ...
                  <div className="bg-blue-50/50 border border-blue-200/30 rounded-xl sm:rounded-2xl p-3 sm:p-4">
                    <div className="flex items-start gap-2 sm:gap-3">
                      <AlertTriangle className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                      <div>
                        <p className="text-sm sm:text-base text-blue-800 font-medium">Important</p>
                        <p className="text-xs sm:text-sm text-blue-700">In the scope justification field for <code>gmail.readonly</code>, add:</p>
                        <p className="text-xs sm:text-sm text-blue-700 italic mt-1">"Required to automatically read OTP verification codes from ERP system emails. Without this permission, the extension cannot function."</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white/60 backdrop-blur-2xl rounded-2xl sm:rounded-3xl border border-white/40 shadow-2xl p-4 sm:p-6 md:p-8">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="p-2 sm:p-3 bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-xl sm:rounded-2xl border border-orange-200/30">
            ...
            <div className="bg-white/60 backdrop-blur-2xl rounded-2xl sm:rounded-3xl border border-white/40 shadow-2xl p-4 sm:p-6 md:p-8">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="p-2 sm:p-3 bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-xl sm:rounded-2xl border border-indigo-200/30">
              ...
              <div className="space-y-3 sm:space-y-4">
                <p className="text-sm sm:text-base text-slate-600">After creation, copy the <strong>Client ID</strong> and update your extension's manifest.json:</p>
                <div className="bg-slate-900 rounded-xl sm:rounded-2xl p-4 sm:p-6 overflow-x-auto">
  ...
  "oauth2": {
    ...
    "scopes": [
      ...
      "openid"
          ...
          <div className="space-y-4 sm:space-y-6">
            {/* Quick Tips */}
            <div className="bg-gradient-to-br from-blue-50/80 to-purple-50/80 backdrop-blur-2xl rounded-2xl sm:rounded-3xl border border-blue-200/40 shadow-2xl p-4 sm:p-6">
            ...
            {/* Publishing Info */}
            <div className="bg-white/60 backdrop-blur-2xl rounded-2xl sm:rounded-3xl border border-white/40 shadow-2xl p-4 sm:p-6">
              <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-3 sm:mb-4 flex items-center gap-2">
            ...
            {/* Support Links */}
            <div className="bg-white/60 backdrop-blur-2xl rounded-2xl sm:rounded-3xl border border-white/40 shadow-2xl p-4 sm:p-6">
              <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-3 sm:mb-4">Need Help?</h3>
